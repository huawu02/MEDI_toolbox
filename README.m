...
% 2) Change 'smv' radius to 3, RDF looks .
%[QSM,~,~,resultfile] = MEDI_L1('lambda',1000,'lambda_CSF',100,'merit','smv',5);  
[QSM,~,~,resultfile] = MEDI_L1('lambda',1000,'lambda_CSF',100,'merit');  
QSM_outname = 'QSM_MEDI_noSMV';
...
status = system(['~/Documents/GitHub/dcm2niix/build/bin/dcm2niix -z y -w 1 -b n -f %x_%s_%d ' dicom_outdir]);
